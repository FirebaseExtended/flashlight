...
SearchQueue.prototype = {
  ...
  _housekeeping: function() {
    ...
    this.outRef.set(null).then(function(err) {
      if (err) {
        console.log("housekeeping: Mainenance failed: " + err);
      }
      else {
        console.log("housekeeping: Performed maintenance, nuking all stale responses older than " 
