...
PathMonitor.prototype = {
   _init: function() {
      this.addMonitor = this.ref.limitToFirst(300).on('child_added', this._process.bind(this, this._childAdded));
      this.changeMonitor = this.ref.limitToFirst(300).on('child_changed', this._process.bind(this, this._childChanged));
      this.removeMonitor = this.ref.limitToFirst(300).on('child_removed', this._process.bind(this, this._childRemoved));
   },
   ...
   _childAdded: function(key, data) {
     console.log('childAdded:' + key.key);
